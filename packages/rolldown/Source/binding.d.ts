...
export declare class BindingWatcher {
	constructor(
		options: Array<BindingBundlerOptions>,
		notifyOption?: BindingNotifyOption | undefined | null,
	);
	close(): Promise<void>;
...
export type BindingBuiltinPluginName =
	| "builtin:wasm-helper"
	| "builtin:import-glob"
...
export type BindingJsonPluginStringify = boolean | string;
...
export interface BindingOutputOptions {
	...
	) => MaybePromise<VoidNullable<string>>;
	dir?: string;
	file?: string;
...
export interface BindingPluginOptions {
	...
	renderChunk?: (
		...
		chunk: BindingRenderedChunk,
		opts: BindingNormalizedOptions,
		chunks: Record<string, BindingRenderedChunk>,
...
export interface BindingTreeshake {
	moduleSideEffects:
		...
		| ((id: string, is_external: boolean) => boolean | undefined);
	annotations?: boolean;
 ...
 */
export declare function parseSyncRaw(
	filename: string,
	buffer: Uint8Array,
	sourceLen: number,
	options?: ParserOptions | undefined | null,
...
export declare function registerPlugins(
	id: number,
	plugins: Array<BindingPluginWithIndex>,
): void;
