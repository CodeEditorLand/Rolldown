...
pub trait StatementExt<'me, 'ast> {
	...
	fn as_export_default_declaration_mut(&'me mut self) -> Option<&'me mut ast::ExportDefaultDeclaration<'ast>>;
...
impl<'ast> StatementExt<'_, 'ast> for ast::Statement<'ast> {
	...
	fn as_export_default_declaration_mut(&mut self) -> Option<&mut ast::ExportDefaultDeclaration<'ast>> {
