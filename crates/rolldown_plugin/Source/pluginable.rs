...
use crate::{
	HookAddonArgs, HookBuildEndArgs, HookBuildStartArgs, HookGenerateBundleArgs, HookInjectionOutputReturn,
	HookLoadArgs, HookRenderChunkArgs, HookRenderStartArgs, HookResolveIdArgs, HookTransformArgs, Plugin,
...
pub trait Pluginable: Any + Debug + Send + Sync + 'static {
	...
	async fn call_build_start(&self, _ctx: &PluginContext, _args: &HookBuildStartArgs) -> HookNoopReturn;

	fn call_build_start_meta(&self) -> Option<PluginHookMeta>;

	async fn call_resolve_id(&self, _ctx: &PluginContext, _args: &HookResolveIdArgs) -> HookResolveIdReturn;

	fn call_resolve_id_meta(&self) -> Option<PluginHookMeta>;

	#[deprecated(note = "This hook is only for rollup compatibility, please use `resolve_id` instead.")]
	async fn call_resolve_dynamic_import(&self, _ctx: &PluginContext, _args: &HookResolveIdArgs)
	-> HookResolveIdReturn;
	...
	async fn call_transform_ast(&self, _ctx: &PluginContext, args: HookTransformAstArgs<'_>) -> HookTransformAstReturn;
	...
	async fn call_build_end(&self, _ctx: &PluginContext, _args: Option<&HookBuildEndArgs>) -> HookNoopReturn;

	fn call_build_end_meta(&self) -> Option<PluginHookMeta>;

	// --- Generate hooks ---

	async fn call_render_start(&self, _ctx: &PluginContext, _args: &HookRenderStartArgs) -> HookNoopReturn;

	fn call_render_start_meta(&self) -> Option<PluginHookMeta>;

	async fn call_banner(&self, _ctx: &PluginContext, _args: &HookAddonArgs) -> HookInjectionOutputReturn;

	fn call_banner_meta(&self) -> Option<PluginHookMeta>;

	async fn call_footer(&self, _ctx: &PluginContext, _args: &HookAddonArgs) -> HookInjectionOutputReturn;

	fn call_footer_meta(&self) -> Option<PluginHookMeta>;

	async fn call_intro(&self, _ctx: &PluginContext, _args: &HookAddonArgs) -> HookInjectionOutputReturn;

	fn call_intro_meta(&self) -> Option<PluginHookMeta>;

	async fn call_outro(&self, _ctx: &PluginContext, _args: &HookAddonArgs) -> HookInjectionOutputReturn;

	fn call_outro_meta(&self) -> Option<PluginHookMeta>;

	async fn call_render_chunk(&self, _ctx: &PluginContext, _args: &HookRenderChunkArgs) -> HookRenderChunkReturn;
	...
	async fn call_render_error(&self, _ctx: &PluginContext, _args: &HookRenderErrorArgs) -> HookNoopReturn;

	fn call_render_error_meta(&self) -> Option<PluginHookMeta>;

	async fn call_generate_bundle(&self, _ctx: &PluginContext, _args: &mut HookGenerateBundleArgs) -> HookNoopReturn;

	fn call_generate_bundle_meta(&self) -> Option<PluginHookMeta>;

	async fn call_write_bundle(&self, _ctx: &PluginContext, _args: &mut HookWriteBundleArgs) -> HookNoopReturn;
	...
	async fn call_watch_change(&self, _ctx: &PluginContext, _path: &str, _event: WatcherChangeKind) -> HookNoopReturn {
		Ok(())
	}
...
impl<T: Plugin> Pluginable for T {
	...
	async fn call_build_start(&self, ctx: &PluginContext, args: &HookBuildStartArgs) -> HookNoopReturn {
	...
	async fn call_resolve_id(&self, ctx: &PluginContext, args: &HookResolveIdArgs) -> HookResolveIdReturn {
	...
	#[allow(deprecated)]
	async fn call_resolve_dynamic_import(&self, ctx: &PluginContext, args: &HookResolveIdArgs) -> HookResolveIdReturn {
	...
	async fn call_transform(&self, ctx: SharedTransformPluginContext, args: &HookTransformArgs) -> HookTransformReturn {
	...
	async fn call_build_end(&self, ctx: &PluginContext, args: Option<&HookBuildEndArgs>) -> HookNoopReturn {
	...
	async fn call_render_start(&self, ctx: &PluginContext, args: &HookRenderStartArgs) -> HookNoopReturn {
	...
	async fn call_banner(&self, ctx: &PluginContext, args: &HookAddonArgs) -> HookInjectionOutputReturn {
	...
	async fn call_footer(&self, ctx: &PluginContext, args: &HookAddonArgs) -> HookInjectionOutputReturn {
	...
	async fn call_intro(&self, ctx: &PluginContext, args: &HookAddonArgs) -> HookInjectionOutputReturn {
	...
	async fn call_outro(&self, ctx: &PluginContext, args: &HookAddonArgs) -> HookInjectionOutputReturn {
	...
	async fn call_render_chunk(&self, ctx: &PluginContext, args: &HookRenderChunkArgs) -> HookRenderChunkReturn {
	...
	async fn call_render_error(&self, ctx: &PluginContext, args: &HookRenderErrorArgs) -> HookNoopReturn {
	...
	async fn call_generate_bundle(&self, ctx: &PluginContext, args: &mut HookGenerateBundleArgs) -> HookNoopReturn {
	...
	async fn call_write_bundle(&self, ctx: &PluginContext, args: &mut HookWriteBundleArgs) -> HookNoopReturn {
	...
	async fn call_watch_change(&self, ctx: &PluginContext, path: &str, event: WatcherChangeKind) -> HookNoopReturn {
	...
	async fn call_transform_ast(&self, ctx: &PluginContext, args: HookTransformAstArgs<'_>) -> HookTransformAstReturn {
