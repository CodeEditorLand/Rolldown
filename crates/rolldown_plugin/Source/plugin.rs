...
pub trait Plugin: Any + Debug + Send + Sync + 'static {
	...
	fn build_start_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn resolve_id_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn resolve_dynamic_import_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn load_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn transform_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn module_parsed_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn build_end_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn render_start_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn banner_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn footer_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn intro_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn outro_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn render_chunk_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn augment_chunk_hash_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn render_error_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn generate_bundle_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn write_bundle_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn close_bundle_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn watch_change_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn close_watcher_meta(&self) -> Option<PluginHookMeta> { None }
	...
	fn transform_ast_meta(&self) -> Option<PluginHookMeta> { None }

	fn transform_filter(&self) -> anyhow::Result<Option<TransformHookFilter>> { Ok(None) }

	fn resolve_id_filter(&self) -> anyhow::Result<Option<ResolvedIdHookFilter>> { Ok(None) }

	fn load_filter(&self) -> anyhow::Result<Option<LoadHookFilter>> { Ok(None) }
}
