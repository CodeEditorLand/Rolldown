use oxc::{index::IndexVec, semantic::SymbolId, span::CompactStr as CompactString};
...
impl Symbols {
	pub fn alloc_one(&mut self) { self.inner.push(IndexVec::default()); }
	...
	pub fn get_original_name(&self, refer:SymbolRef) -> &CompactString { &self.get(refer).name }
	...
	pub fn get(&self, refer:SymbolRef) -> &Symbol { &self.inner[refer.owner][refer.symbol] }
