use rolldown_common::{Chunk, ChunkKind, ModuleId, RenderedModule, RollupPreRenderedChunk, RollupRenderedChunk};
...
pub fn generate_pre_rendered_chunk(chunk: &Chunk, graph: &LinkStageOutput) -> RollupPreRenderedChunk {
