...
use rolldown_common::{
	Chunk, ChunkKind, EntryPointKind, ExportsKind, IndexModules, ModuleIdx, NormalizedBundlerOptions, OutputExports,
...
pub fn render_wrapped_entry_chunk(ctx: &GenerateContext<'_>, export_mode: Option<&OutputExports>) -> Option<String> {
...
pub fn render_chunk_exports(ctx: &GenerateContext<'_>, export_mode: Option<&OutputExports>) -> Option<String> {
  ...
  if (k !== 'default' && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
    ...
    get: function () { return $NAME[k]; }
						...
						s.push_str(&format!(
							"\nvar {} = require(\"{}\");\n",
							binding_ref_name,
							&external.get_import_path(chunk)
						));
