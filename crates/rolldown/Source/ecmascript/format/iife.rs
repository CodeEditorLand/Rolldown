...
use crate::utils::chunk::render_chunk_exports::{get_chunk_export_names, render_wrapped_entry_chunk};
use crate::{
...
use super::utils::{
	render_chunk_external_imports, render_factory_parameters, render_modules_with_peek_runtime_module_at_first,
};
...
pub async fn render_iife<'code>(
	...
	// iife wrapper end
	let factory_arguments = render_iife_factory_arguments(warnings, ctx, &externals, exports_prefix).await;
