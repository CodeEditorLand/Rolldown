...
use rolldown_common::{
	ImportKind, ImportRecordIdx, ImportRecordMeta, Module, ModuleIdx, ModuleTable, OutputFormat, ResolvedImportRecord,
	StmtInfoMeta, WrapKind, side_effects::DeterminedSideEffects,
};
use rolldown_utils::{
	concat_string,
...
fn is_external_dynamic_import(table: &ModuleTable, record: &ResolvedImportRecord, module_idx: ModuleIdx) -> bool {
