...
use rolldown_plugin::{HookLoadArgs, HookLoadReturn, HookNoopReturn, HookResolveIdArgs, HookResolveIdReturn};

pub trait CallablePlugin: Send + Sync + 'static {
	fn name(&self) -> Cow<'static, str>;

	fn resolve_id(&self, args: &HookResolveIdArgs) -> impl Future<Output = HookResolveIdReturn> + Send;
