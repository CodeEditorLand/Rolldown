...
pub type ChunkFileNamesOutputOption = Either<String, JsCallback<FnArgs<(PreRenderedChunk,)>, String>>;
pub type AssetFileNamesOutputOption = Either<String, JsCallback<FnArgs<(BindingPreRenderedAsset,)>, String>>;
pub type GlobalsOutputOption = Either<FxHashMap<String, String>, JsCallback<FnArgs<(String,)>, String>>;
