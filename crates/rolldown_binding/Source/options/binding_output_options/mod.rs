...
use super::{
	super::types::binding_rendered_chunk::RenderedChunk,
	plugin::BindingPluginOrParallelJsPluginPlaceholder,
};
use crate::types::{
	binding_pre_rendered_chunk::PreRenderedChunk,
...
pub struct BindingOutputOptions {
	...
	// pub entry_file_names: String, // | ((chunkInfo: PreRenderedChunk) =>
	// string)
	#[serde(skip_deserializing)]
