...
pub struct BindingPluginOptions {
	...
	#[serde(skip_deserializing)]
	#[napi(ts_type = "(ctx: BindingPluginContext, error: Nullable<string>) => \
	                  MaybePromise<VoidNullable>")]
	...
	#[serde(skip_deserializing)]
	#[napi(ts_type = "(ctx: BindingPluginContext, code: string, chunk: RenderedChunk) => \
	...
	#[serde(skip_deserializing)]
	#[napi(
		ts_type = "(ctx: BindingPluginContext, bundle: BindingOutputs, isWrite: boolean) => \
		           MaybePromise<VoidNullable>"
	)]
	pub generate_bundle:
	...
	#[serde(skip_deserializing)]
	#[napi(ts_type = "(ctx: BindingPluginContext, bundle: BindingOutputs) => \
	                  MaybePromise<VoidNullable>")]
