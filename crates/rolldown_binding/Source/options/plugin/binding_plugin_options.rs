...
pub type BindingPluginOrParallelJsPluginPlaceholder = Option<Either<BindingPluginOptions, BindingBuiltinPlugin>>;
...
pub struct BindingPluginOptions {
	...
	#[napi(ts_type = "(ctx: BindingPluginContext, opts: BindingNormalizedOptions) => MaybePromise<VoidNullable>")]
	pub build_start: Option<MaybeAsyncJsCallback<FnArgs<(BindingPluginContext, BindingNormalizedOptions)>, ()>>,
	...
	#[napi(ts_type = "(ctx: BindingPluginContext, id: string) => MaybePromise<VoidNullable<BindingHookLoadOutput>>")]
	pub load: Option<MaybeAsyncJsCallback<FnArgs<(BindingPluginContext, String)>, Option<BindingHookLoadOutput>>>,
	...
	#[napi(ts_type = "(ctx: BindingPluginContext, module: BindingModuleInfo) => MaybePromise<VoidNullable>")]
	pub module_parsed: Option<MaybeAsyncJsCallback<FnArgs<(BindingPluginContext, BindingModuleInfo)>, ()>>,
	...
	#[napi(ts_type = "(ctx: BindingPluginContext, chunk: BindingRenderedChunk) => MaybePromise<void | string>")]
	pub augment_chunk_hash:
		Option<MaybeAsyncJsCallback<FnArgs<(BindingPluginContext, BindingRenderedChunk)>, Option<String>>>,
	...
	pub render_start: Option<MaybeAsyncJsCallback<FnArgs<(BindingPluginContext, BindingNormalizedOptions)>, ()>>,
	...
	pub render_error: Option<
		MaybeAsyncJsCallback<FnArgs<(BindingPluginContext, Vec<napi::Either<napi::JsError, BindingError>>)>, ()>,
	>,
	...
	#[napi(ts_type = "(ctx: BindingPluginContext, path: string, event: string) => MaybePromise<VoidNullable>")]
	...
	pub banner: Option<MaybeAsyncJsCallback<FnArgs<(BindingPluginContext, BindingRenderedChunk)>, Option<String>>>,
	pub banner_meta: Option<BindingPluginHookMeta>,

	#[napi(ts_type = "(ctx: BindingPluginContext, chunk: BindingRenderedChunk) => void")]
	pub footer: Option<MaybeAsyncJsCallback<FnArgs<(BindingPluginContext, BindingRenderedChunk)>, Option<String>>>,
	pub footer_meta: Option<BindingPluginHookMeta>,

	#[napi(ts_type = "(ctx: BindingPluginContext, chunk: BindingRenderedChunk) => void")]
	pub intro: Option<MaybeAsyncJsCallback<FnArgs<(BindingPluginContext, BindingRenderedChunk)>, Option<String>>>,
	pub intro_meta: Option<BindingPluginHookMeta>,

	#[napi(ts_type = "(ctx: BindingPluginContext, chunk: BindingRenderedChunk) => void")]
	pub outro: Option<MaybeAsyncJsCallback<FnArgs<(BindingPluginContext, BindingRenderedChunk)>, Option<String>>>,
	pub outro_meta: Option<BindingPluginHookMeta>,
}

impl Debug for BindingPluginOptions {
	fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("BindingPluginOptions")
