...
pub struct BindingInputOptions {
	...
	#[napi(
		ts_type = "undefined | ((source: string, importer: string | undefined, isResolved: \
		           boolean) => boolean)"
	)]
	...
	// moduleContext?: ((id: string) => string | null | void) | { [id: string]:
	// string }; onwarn?: WarningHandlerWithDefault;
	// perf?: boolean;
	#[serde(skip_deserializing)]
