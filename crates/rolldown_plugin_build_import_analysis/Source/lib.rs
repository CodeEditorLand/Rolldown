...
/// First element is the import specifier, second element is `decls` or `props`
/// of expr
#[derive(Debug)]
...
impl Plugin for BuildImportAnalysisPlugin {
	fn name(&self) -> Cow<'static, str> { Cow::Borrowed("builtin:build-import-analysis") }
