...
/// # Usage
/// - `import { Promise } from 'es6-promise'` => `InjectImport::named("Promise",
///   None,"es6-promise")`
/// - `import { Promise as P } from 'es6-promise'` =>
///   `InjectImport::named("Promise", Some("P"), "es6-promise")`
/// - `import $ from 'jquery'` => `InjectImport::named("default", Some("$"),
///   "jquery")`
/// - `import $ from 'jquery'` => `InjectImport::default("$", "jquery")`
/// - `import * as fs from 'node:fs'` => `InjectImport::namespace("fs",
///   "node:fs")`
///
/// ---
///
/// - `InjectImport::named("default", Some("Object.assign"),
///   "es6-object-assign")`
...
impl InjectImport {
	...
	pub fn namespace(alias:String, from:String) -> Self { Self::Namespace { from, alias } }
