...
// The prefix `Rollup` shows that this is struct is designed for compatibility
// with Rollup. Adding the `Rollup` prefix to show how much types are only used
// for compatibility with Rollup.
#[derive(Debug, Clone)]
