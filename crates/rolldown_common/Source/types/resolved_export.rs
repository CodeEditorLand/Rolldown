...
pub struct ResolvedExport {
	// Because create export star exports happens before linking imports, The
	// symbols can't  determine if duplicate names from export star resolution
	// are ambiguous (point to different symbols) or not (point to the same
	// symbol). Here is a example:
	//
	//   // entry.js
	//   export * from './a'
	//   export * from './b'
