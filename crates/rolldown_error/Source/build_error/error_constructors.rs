...
use super::{BuildDiagnostic, severity::Severity};
#[cfg(feature = "napi")]
use crate::events::NapiError;
use crate::{
	events::{
		DiagnosableArcstr,
		ambiguous_external_namespace::{
			AmbiguousExternalNamespace,
			AmbiguousExternalNamespaceModule,
		},
		assign_to_import::AssignToImport,
		circular_dependency::CircularDependency,
		commonjs_variable_in_esm::{CjsExportSpan, CommonJsVariableInEsm},
		eval::Eval,
		export_undefined_variable::ExportUndefinedVariable,
		external_entry::ExternalEntry,
		forbid_const_assign::ForbidConstAssign,
		illegal_identifier_as_name::IllegalIdentifierAsName,
		import_is_undefined::ImportIsUndefined,
		invalid_define_config::InvalidDefineConfig,
		invalid_export_option::InvalidExportOption,
		invalid_option::{InvalidOption, InvalidOptionType},
		json_parse::JsonParse,
		missing_export::MissingExport,
		missing_global_name::MissingGlobalName,
		missing_name_option_for_iife_export::MissingNameOptionForIifeExport,
		missing_name_option_for_umd_export::MissingNameOptionForUmdExport,
		mixed_export::MixedExport,
		parse_error::ParseError,
		resolve_error::DiagnosableResolveError,
		sourcemap_error::SourceMapError,
		unhandleable_error::UnhandleableError,
		unloadable_dependency::{UnloadableDependency, UnloadableDependencyContext},
...
impl BuildDiagnostic {
	...
	pub fn unloadable_dependency(
		...
		downcast_napi_error_diagnostics(err).unwrap_or_else(|err| {
			Self::new_inner(UnloadableDependency {
				resolved,
				context,
	...
	pub fn forbid_const_assign(
		...
		Self::new_inner(ForbidConstAssign {
			filename,
			source,
			name,
			reference_span,
