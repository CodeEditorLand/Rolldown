...
impl BuildEvent for Eval {
	fn kind(&self) -> crate::event_kind::EventKind { crate::event_kind::EventKind::Eval }

	fn message(&self, _opts:&DiagnosticOptions) -> String {
		format!(
			"Use of eval in '{}' is strongly discouraged as it poses security risks and may cause \
	...
	fn on_diagnostic(&self, diagnostic:&mut Diagnostic, opts:&DiagnosticOptions) {
		...
		diagnostic.title = "Use of eval is strongly discouraged as it poses security risks and \
